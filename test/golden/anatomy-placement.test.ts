...
function syntheticContext(): PipelineContext {
  return {
    ...
    materialProfile: {
      ...
      inlayMarginExclusionMm: 1.3, onlayMarginExclusionMm: 1.8, frameworkMinThicknessMm: 0.5, ponticHygienicClearanceMm: 2.0, ponticRidgeLapReliefMm: 0.05, ponticOvateDepthMm: 1.0, veneeringSpaceMm: 1.0,
    },
    insertionAxis: [0, 0, 1],
